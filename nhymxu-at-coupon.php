...
defined( 'ABSPATH' ) || die;
define('NHYMXU_AT_COUPON_VER', "0.4.0");
		...
		<?php foreach( $at_coupons as $row ): ?>
			<div class="coupondiv">
				<div class="promotiontype">
					...
					<?php else: ?>
					<div class="cpbutton btn-xemngay">
